...
export function startSepoliaListener() {
  ...
  const contract = new ethers.Contract(process.env.CONTRACT_ADDRESS_SEPOLIA, abi, provider);
  const chain = "sepolia";

  console.log("🔍 Sepolia listener active...");
